...
export const optionStrings: object[] = [
  ...
  {dbitem: 'hmmscan', options: sortBy([
      {param: 'T', valueType: 'number', defaultValue: '0.0', min: 0, max: undefined, values: []},
      {param: 'domE', valueType: 'evalue', defaultValue: '10', min: 0, max: undefined, values: []},
      {param: 'domT', valueType: 'number', defaultValue: '0.0', min: 0, max: undefined, values: []},
      {param: 'incE', valueType: 'evalue', defaultValue: '10', min: 0, max: undefined, values: []},
      {param: 'incT', valueType: 'number', defaultValue: '0.0', min: 0, max: undefined, values: []},
      {param: 'incdomE', valueType: 'evalue', defaultValue: '10', min: 0, max: undefined, values: []},
      {param: 'incdomT', valueType: 'number', defaultValue: '0.0', min: 0, max: undefined, values: []},
      {param: 'F1', valueType: 'number', defaultValue: '0.02', min: 0, max: undefined, values: []},
      {param: 'F2', valueType: 'number', defaultValue: '0.001', min: 0, max: undefined, values: []},
      {param: 'F3', valueType: 'number', defaultValue: '0.00001', min: 0, max: undefined, values: []},
      {param: 'nobias', valueType: 'none', defaultValue: '', min: undefined, max: undefined, values: []},
      {param: 'nonull2', valueType: 'none', defaultValue: '', min: undefined, max: undefined, values: []},
      {param: 'Z', valueType: 'int', defaultValue: '', min: 0, max: undefined, values: []},
      {param: 'domZ', valueType: 'int', defaultValue: '', min: 0, max: undefined, values: []},
      {param: 'seed', valueType: 'int', defaultValue: '42', min: 0, max: undefined, values: []},
      {param: 'evalue', valueType: 'evalue', defaultValue: '0.001', min: 0, max: undefined, values: []},
      {param: 'cut_ga', valueType: 'none', defaultValue: '', min: undefined, max: undefined, values: []},
      {param: 'cut_nc', valueType: 'none', defaultValue: '', min: undefined, max: undefined, values: []},
      {param: 'cut_tc', valueType: 'none', defaultValue: '', min: undefined, max: undefined, values: []},
    ], "param")
  },
  ...
  {dbitem: 'diamond blastp', options: sortBy([
      {param: 'strand', valueType: 'enum', defaultValue: 'both', min: undefined, max: undefined, values: ['both', 'minus', 'plus']},
      ...
      {param: 'query-cover', valueType: 'number', defaultValue: 0, min: 0, max: 100, values: []},
      {param: 'subject-cover', valueType: 'number', defaultValue: '0', min: 0, max: '100', values: []},
      {param: 'sensitive', valueType: 'none', defaultValue: '', min: undefined, max: undefined, values: []},
      {param: 'more-sensitive', valueType: 'none', defaultValue: '', min: undefined, max: undefined, values: []},
      {param: 'block-size', valueType: 'number', defaultValue: '2.0', min: 0, max: undefined, values: []},
      {param: 'gapopen', valueType: 'int', defaultValue: '0', min: 0, max: undefined, values: []},
      {param: 'gapextend', valueType: 'int', defaultValue: '0', min: 0, max: undefined, values: []},
      {param: 'frameshift', valueType: 'int', defaultValue: '0', min: 0, max: undefined, values: []},
      {param: 'matrix', valueType: 'enum', defaultValue: 'BLOSUM62', min: undefined, max: undefined,
        values: ['BLOSUM62', 'BLOSUM90', 'BLOSUM80', 'BLOSUM50', 'BLOSUM45', 'PAM250', 'PAM70', 'PAM30']},
      {param: 'comp-based-stats', valueType: 'enum', defaultValue: '1', min: undefined, max: undefined, values: [0, 1]},
      {param: 'masking', valueType: 'enum', defaultValue: '1', min: undefined, max: undefined, values: [0, 1]},
      {param: 'algo', valueType: 'enum', defaultValue: '0', min: undefined, max: undefined, values: [0, 1]},
      {param: 'freq-sd', valueType: 'number', defaultValue: '', min: 0, max: undefined, values: []},
      {param: 'id2', valueType: 'number', defaultValue: '', min: 0, max: undefined, values: []},
      {param: 'window', valueType: 'int', defaultValue: '', min: 0, max: undefined, values: []},
      {param: 'xdrop', valueType: 'int', defaultValue: '', min: 1, max: undefined, values: []},
      {param: 'ungapped-score', valueType: 'number', defaultValue: '', min: 0, max: undefined, values: []},
      {param: 'hit-band', valueType: 'string', defaultValue: '', min: undefined, max: undefined, values: []},
      {param: 'hit-score', valueType: 'number', defaultValue: '', min: 0, max: undefined, values: []},
      {param: 'gapped-xdrop', valueType: 'int', defaultValue: '', min: 1, max: undefined, values: []},
      {param: 'band', valueType: 'string', defaultValue: '', min: '-1', max: '-1', values: []},
      {param: 'shapes', valueType: 'int', defaultValue: '0', min: 0, max: undefined, values: []},
      {param: 'shape-mask', valueType: 'int', defaultValue: '', min: 0, max: undefined, values: []},
      {param: 'index-mode', valueType: 'enum', defaultValue: '0', min: undefined, max: undefined, values: [0, 1]},
      {param: 'rank-ratio', valueType: 'none', defaultValue: '', min: undefined, max: undefined, values: []},
      {param: 'rank-ratio2', valueType: 'none', defaultValue: '', min: undefined, max: undefined, values: []},
      {param: 'max-hsps', valueType: 'int', defaultValue: '1', min: 1, max: undefined, values: []},
      {param: 'dbsize', valueType: 'int', defaultValue: '40000000', min: 1, max: undefined, values: []},
      {param: 'evalue', valueType: 'evalue', defaultValue: '0.001', min: 0, max: undefined, values: []},
    ], "param")
  }
];
