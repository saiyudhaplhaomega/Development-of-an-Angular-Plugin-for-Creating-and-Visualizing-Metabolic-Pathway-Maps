...
export const optionStrings: object[] = [
  {dbitem: 'emapper', options: sortBy([
      ...
      {param: 'hmm_evalue', valueType: 'evalue', defaultValue: '0.001', min: 0.0, max: undefined, values: [], default: 1},
      ...
      {param: 'seed_ortholog_score', valueType: 'number', defaultValue: '60.0', min: 0, max: undefined, values: [], default: 1},
      {param: 'm', valueType: 'enum', defaultValue: 'diamond', min: undefined, max: undefined,
        values: ['diamond', 'hmmer'], default: 0},
    ], 'param')
  },
  {dbitem: 'hmmscan', options: sortBy([
      {param: 'T', valueType: 'number', defaultValue: '0.0', min: 0, max: undefined, values: [], default: 0},
      {param: 'domE', valueType: 'evalue', defaultValue: '10', min: 0, max: undefined, values: [], default: 0},
      {param: 'domT', valueType: 'number', defaultValue: '0.0', min: 0, max: undefined, values: [], default: 0},
      {param: 'incE', valueType: 'evalue', defaultValue: '10', min: 0, max: undefined, values: [], default: 0},
      {param: 'incT', valueType: 'number', defaultValue: '0.0', min: 0, max: undefined, values: [], default: 0},
      {param: 'incdomE', valueType: 'evalue', defaultValue: '10', min: 0, max: undefined, values: [], default: 0},
