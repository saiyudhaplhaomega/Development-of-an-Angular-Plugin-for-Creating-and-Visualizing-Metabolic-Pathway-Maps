...
@Component({
  ...
  templateUrl: './REFACTORING_prophane-job-submission.component.html',
  styleUrls: ['./REFACTORING_prophane-job-submission.component.css'],
  encapsulation: ViewEncapsulation.None,
  providers: [NgbTooltipConfig]
})

export class REFACTORING_prophaneJobSubmissionComponent implements OnInit {
